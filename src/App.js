...
function Card({ username, avatar, date, message, alt, hideButton }) {
  return (
        ...
        <div className="px-4 py-5 sm:px-6">
          <div className="flex space-x-3">
            <div className="flex-shrink-0">
              <img className="h-10 w-10 rounded-full" src={avatar} alt={alt} />
            </div>
  ...
  return (
    <div className="bg-gray-100">
      <Card
        ...
        message="Lorem ipsum dolor sit, amet consectetur adipisicing elit. Illo
